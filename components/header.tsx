            ...
            <HStack w="100%" h="100%" px="6" align="center" justify="space-between">
                <Flex align="center">
                    <NextLink href="/" passHref>
                        <chakra.a display="block" aria-label="REXS Homepage">
                            <Logo/>
                        </chakra.a>
                    </NextLink>
                </Flex>
                ...
                <HStack spacing="5" display={{ base: "none", md: "flex" }}>
                    <Link
                        isExternal
                        aria-label="Go to REXS' GitHub page"
                        href="https://github.com/uellenberg/REXS"
                    >
                        <Icon
                            as={GithubIcon}
                            display="block"
                    ...
                    <Link
                        isExternal
                        aria-label="Go to REXS' NPM page"
                        href="https://npmjs.com/package/rexs"
                    >
                        <Icon
                            as={NPMIcon}
                            display="block"
                ...
                <RemoveScroll forwardProps>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <MenuLink text="Github" url="https://github.com/uellenberg/REXS" aria="Github Page" category isExternal/>
                                <MenuLink text="NPM" url="https://npmjs.com/package/rexs" aria="NPM Page" category isExternal/>
                                <MenuItems/>
                            </ScrollView>
                        </Flex>
                    </motion.div>
